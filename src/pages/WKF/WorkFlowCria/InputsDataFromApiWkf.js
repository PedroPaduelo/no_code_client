...
export function InputsDataFromApiWkf({wkf}) {
  ...
  const { CreatWkfVariablesIn, tbl_wkf_variables_ins, DeletWkfVariablesIn, UpdateWkfVariablesIn } = useWorkFlowVariables();
  

  const handleEditVar = useCallback(async(dados) => {
    svar_id(dados.id)
